...
from models import Movie, MovieGenre, User, Rating, Link, Tag
            ...
            for row in reader:
                if count > 0:
                    try:
                        ...
                        print("Ignoring duplicate tag for movie_id: " + movie_id)
                        db.session.rollback()
                        pass
                count += 1
                if count % 100 == 0:
            ...
            for row in reader:
                if count > 0:
                    try:
                        ...
                        print("Ignoring duplicate rating for movie_id: " + movie_id)
                        db.session.rollback()
                        pass
                count += 1
                if count % 100 == 0:
